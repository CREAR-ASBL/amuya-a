...
//        String cSpan = "</span>";
    ...
    static String getRamFormulationLatex(Disjunction d) {
        ...
        String f1i = "^{" + amuyaña.getF1Abb(d) + "}";
        String f2i = "^{" + amuyaña.getF2Abb(d) + "}";
        
        String PC = "^{" + amuyaña.getCon1Abb(d) + "}";
        String NC = "^{" + amuyaña.getCon2Abb(d) + "}";
        String SC = "^{" + amuyaña.getCon3Abb(d) + "}";
        ...
        String equiv= "\\equiv{}";
        String I = "\\supset{}";
        String E = "\\overline{\\supset}";
        
        return "<html>" + dis + equiv + oP + f1 + dot + f2 + cP + equiv + oP + 
            oP + oP + I + f1i + A + cP + I + PC + oP + E + f2i + P + cP + cP + or +
            oP + oP + E + f2i + A + cP + I + NC + oP + I + f1i + P + cP + cP + or +
            oP + oP + I + f1i + T + cP + I + SC + oP + E + f2i + T + cP + cP + cP +
            "</html>";
    }
